...
package com.purebook.purebook_android.core.login;
    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        logo = ((ImageView) hasViews.findViewById(id.activity_login_logo));
        loginButton = ((Button) hasViews.findViewById(id.activity_login_login_button));
        userPasswordEditText = ((EditText) hasViews.findViewById(id.activity_login_user_password_text));
        registerButton = ((Button) hasViews.findViewById(id.activity_login_register_button));
        userNameEditText = ((EditText) hasViews.findViewById(id.activity_login_user_name_text));
        if (loginButton!= null) {
