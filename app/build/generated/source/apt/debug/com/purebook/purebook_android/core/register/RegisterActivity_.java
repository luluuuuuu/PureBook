...
package com.purebook.purebook_android.core.register;
    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        logo = ((ImageView) hasViews.findViewById(id.activity_register_logo));
        userConfirmPasswordEditText = ((EditText) hasViews.findViewById(id.activity_register_confirm_user_password_text));
        loginButton = ((Button) hasViews.findViewById(id.activity_register_login_button));
        userPasswordEditText = ((EditText) hasViews.findViewById(id.activity_register_user_password_text));
        userNameEditText = ((EditText) hasViews.findViewById(id.activity_register_user_name_text));
        registerButton = ((Button) hasViews.findViewById(id.activity_register_register_button));
        if (loginButton!= null) {
